...
# Base directory (Docker uses /app as the root)
base_dir = ".."


# Input: geological data (previously 'malta_test')
input_dir = os.path.join(base_dir, 'example_inputs', 'petrel_data')

# Output: where processed model files go
output_dir = os.path.join(base_dir, 'malta_simulation')
...
seawat_dir = os.path.join(base_dir, 'model_files', 'bin', 'SEAWAT', 'swtv4')
...
mswt = flopy.seawat.Seawat(mini_modelname, 'nam_swt', model_ws=mini_sp_dir, exe_name=seawat_dir)
